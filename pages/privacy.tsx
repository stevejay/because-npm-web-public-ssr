...
const PrivacyPage = () => (
  <LegalPageContainer>
    ...
    <p>
      Middle Engine Software Ltd ("us", "we", or "our") operates the {WEBSITE}{" "}
    ...
    <ul>
      <li>
        ...
        <p>
          Service is the {WEBSITE} website operated by Middle Engine Software
          Ltd
        </p>
      </li>
      <li>
    ...
    <h2>Use of Data</h2>
    <p>
      Middle Engine Software Ltd uses the collected data for various purposes:
    </p>
    <ul>
    ...
    <p>
      Middle Engine Software Ltd will take all the steps reasonably necessary to
    ...
    <p>
      Under certain circumstances, Middle Engine Software Ltd may be required to
    ...
    <p>
      Middle Engine Software Ltd may disclose your Personal Data in the good
      faith belief that such action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>
        To protect and defend the rights or property of Middle Engine Software
        Ltd
      </li>
      <li>
